...
fn main() {
    ...
    let amiya = amiya::new().uses(router()
        ...
        .at("static")
            // As above, we give request to "/static" a clear response message that we do support list dir content
            ...
            // at the same, get limit we only support get method for static files
